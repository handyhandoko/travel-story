...
@push('css_style')
    ...
    <link rel="stylesheet" href="{{ url('https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.2.0/dropzone.css') }}">
@endpush
...
@push('js_script')
    ...
    <script src="{{ url('https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.2.0/dropzone.js') }}"></script>
